export const layoutWindowsUs = {
    "Name": "US",
    "layoutName": "QWERTY",
    "Description": "Contains key mappings for windows keyboard QWERTY (United States)",
    "rows": [
      {
        "cells": [
          { "code": "KEY_ESC",  "label": { "normal": "Esc"    }, "special": true, "width": "wide" },
      ...
      {
        "cells": [
          { "code": "KEY_GRAVE",     "label": { "normal": "`",     "shift": "~" }, "special": true },
          { "code": "KEY_1",         "label": { "normal": "1",     "shift": "!" } },
          { "code": "KEY_2",         "label": { "normal": "2",     "shift": "@" } },
          { "code": "KEY_3",         "label": { "normal": "3",     "shift": "#" } },
          { "code": "KEY_4",         "label": { "normal": "4",     "shift": "$" } },
          { "code": "KEY_5",         "label": { "normal": "5",     "shift": "%" } },
          { "code": "KEY_6",         "label": { "normal": "6",     "shift": "^" } },
          { "code": "KEY_7",         "label": { "normal": "7",     "shift": "&" } },
          { "code": "KEY_8",         "label": { "normal": "8",     "shift": "*" } },
          { "code": "KEY_9",         "label": { "normal": "9",     "shift": "(" } },
          { "code": "KEY_0",         "label": { "normal": "0",     "shift": ")" } },
          { "code": "KEY_MINUS",     "label": { "normal": "-",     "shift": "_" } },
          { "code": "KEY_EQUAL",     "label": { "normal": "=",     "shift": "+" } },
      ...
      },
      {
        "cells": [
          ...
          { "code": "KEY_Q",          "label": { "normal": "q",     "shift": "Q" } },
          { "code": "KEY_W",          "label": { "normal": "w",     "shift": "W" } },
          { "code": "KEY_E",          "label": { "normal": "e",     "shift": "E" } },
          ...
          { "code": "KEY_HASHTILDE",  "label": { "normal": "\\",    "shift": "|" }, "width": "wide" }
        ]
      },
      {
        "cells": [
          { "code": "KEY_CAPSLOCK",   "label": { "normal": "\uD83D\uDD12"               }, "special": true, "width": "wider" },
          { "code": "KEY_A",          "label": { "normal": "a",           "shift": "A"  } },
          ...
          { "code": "KEY_SEMICOLON",  "label": { "normal": ";",           "shift": ":"  } },
          { "code": "KEY_APOSTROPHE", "label": { "normal": "'",           "shift": "\"" } },
          { "code": "KEY_ENTER",      "label": { "normal": "Return"                     }, "special": true, "width": "wider" }
        ]
      },
      {
        "cells": [
          ...
          { "code": "KEY_Z",           "label": { "normal": "z",     "shift": "Z" } },
          ...
          { "code": "KEY_M",           "label": { "normal": "m",     "shift": "M" } },
