    ...
    this._trackpadManager.addTrackpadListeners("trackpad", this._elements.trackpad, 
      {
        ...
        [this._trackpadManager.constructor._TRACKPAD_CALLBACK_PRESS_LONG_SINGLE  ]: this.onTrackpadPressLongSingle.bind(this),
        [this._trackpadManager.constructor._TRACKPAD_CALLBACK_MOVE_START_SINGLE  ]: this.onTrackpadMoveStartSingle.bind(this),
        [this._trackpadManager.constructor._TRACKPAD_CALLBACK_MOVE_SINGLE        ]: this.onTrackpadMoveSingle.bind(this),
        [this._trackpadManager.constructor._TRACKPAD_CALLBACK_MOVE_STOP_SINGLE   ]: this.onTrackpadMoveStopSingle.bind(this),
        [this._trackpadManager.constructor._TRACKPAD_CALLBACK_RELEASE_LONG_SINGLE]: this.onTrackpadReleaseLongSingle.bind(this),
        [this._trackpadManager.constructor._TRACKPAD_CALLBACK_TIMEOUT_LONG_DOUBLE]: this.onTrackpadTimeoutLongDouble.bind(this),
        [this._trackpadManager.constructor._TRACKPAD_CALLBACK_CLICK_SHORT_DOUBLE ]: this.onTrackpadClickShortDouble.bind(this),
        [this._trackpadManager.constructor._TRACKPAD_CALLBACK_PRESS_LONG_DOUBLE  ]: this.onTrackpadPressLongDouble.bind(this),
        [this._trackpadManager.constructor._TRACKPAD_CALLBACK_MOVE_START_DOUBLE  ]: this.onTrackpadMoveStartDouble.bind(this),
        [this._trackpadManager.constructor._TRACKPAD_CALLBACK_MOVE_DOUBLE        ]: this.onTrackpadMoveDouble.bind(this),
        [this._trackpadManager.constructor._TRACKPAD_CALLBACK_MOVE_STOP_DOUBLE   ]: this.onTrackpadMoveStopDouble.bind(this),
        [this._trackpadManager.constructor._TRACKPAD_CALLBACK_RELEASE_LONG_DOUBLE]: this.onTrackpadReleaseLongDouble.bind(this)
      }
    );
